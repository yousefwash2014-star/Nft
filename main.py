...
النظام الكامل — نسخة المراقبة الدائمة:
  ...
  - يعيد الفحص كل 10 ثواني (سعر من العقد مباشرة + غاز + كمية متبقية)
...
# ----- متغيرات RPC من Railway (أو أي بيئة) -----
ETHEREUM_RPC_URL = os.environ.get("ETHEREUM_RPC_URL")
ROBINHOOD_RPC_URL = os.environ.get("ROBINHOOD_RPC_URL")
ALCHEMY_API_KEY = os.environ.get("ALCHEMY_API_KEY")  # مفتاح مشترك (اختياري)
...
RECV_TIMEOUT = 5
FREE_PRICE_THRESHOLD_USD = 0.00001
WATCH_POLL_INTERVAL_SECONDS = 3  # <--- تم التغيير من 15 إلى 10
...
# ---------- إعدادات الشبكات (مرنة) ----------
CHAIN_CONFIGS = {}

# ---- إيثيريوم ----
if ETHEREUM_RPC_URL:
    log.info("✅ استخدام ETHEREUM_RPC_URL المخصص.")
    ...
    log.info("✅ استخدام ALCHEMY_API_KEY لتكوين RPC Ethereum.")
    CHAIN_CONFIGS["ethereum"] = {
        "stream_chain_name": "ethereum",
    ...
    log.warning("⚠️ لا يوجد RPC مخصص لإيثيريوم، سيتم استخدام Cloudflare العام.")
    CHAIN_CONFIGS["ethereum"] = {
        "stream_chain_name": "ethereum",
...
if ROBINHOOD_RPC_URL:
    log.info("✅ استخدام ROBINHOOD_RPC_URL المخصص.")
    CHAIN_CONFIGS["robinhood"] = {
        "stream_chain_name": "robinhood",
        "rpc_url": ROBINHOOD_RPC_URL,
        "max_gas_fee_usd": 0.05,
    }
elif ALCHEMY_API_KEY:
    log.info("✅ استخدام ALCHEMY_API_KEY لتكوين RPC Robinhood.")
    CHAIN_CONFIGS["robinhood"] = {
        "stream_chain_name": "robinhood",
    ...
    log.warning("⚠️ ROBINHOOD_RPC_URL غير موجود، لن يتم مراقبة Robinhood.")
...
in_flight: set[str] = set()       # قيد المعالجة حاليًا
